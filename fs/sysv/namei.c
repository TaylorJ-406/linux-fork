...
static int sysv_mknod(const struct mnt_idmap *idmap, struct inode *dir,
...
static int sysv_mkdir(const struct mnt_idmap *idmap, struct inode *dir,
 ...
 */
static int sysv_rename(const struct mnt_idmap *idmap, struct inode *old_dir,
