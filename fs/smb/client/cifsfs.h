...
extern int cifs_create(const struct mnt_idmap *, struct inode *,
...
extern int cifs_mknod(const struct mnt_idmap *, struct inode *, struct dentry *,
		      umode_t, dev_t);
extern int cifs_mkdir(const struct mnt_idmap *, struct inode *, struct dentry *,
		      umode_t);
extern int cifs_rmdir(struct inode *, struct dentry *);
extern int cifs_rename2(const struct mnt_idmap *, struct inode *,
...
extern int cifs_setattr(const struct mnt_idmap *, struct dentry *,
			struct iattr *);
...
extern const char *cifs_get_link(struct dentry *, struct inode *,
			struct delayed_call *);
extern int cifs_symlink(const struct mnt_idmap *idmap, struct inode *inode,
